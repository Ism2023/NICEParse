...
namespace Parser.Core
{
    public static class Simplifier
    {
        ...
        /// <summary>
        /// Use recursion to simplify calculation (including any nested parenthesis)
        /// </summary>
        /// <param name="input">string to process</param>
        /// <returns>string representing simplified calculation</returns>
        ...
        internal static string Rebuild(string input, SubCalc sc)
        {
