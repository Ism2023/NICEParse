...
namespace Parser.Core
{
    public class Processor
    {
        ...
        /// <summary>
        /// Reconcile the current loaded calculation based on the contents of LeftDigitString & RightDigitString
        /// </summary>
        ...
        /// <summary>
        /// Internal Processor for calcuation of simplified string
        /// </summary>
        /// <param name="input">simplified string to process</param>
